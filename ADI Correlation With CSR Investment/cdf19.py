...
f1 = open('./DistrictWiseCSRAndADI_2019.csv')
...
for row1 in csvFileHandler1:
	csrList.append(int(row1[9])/scale)
	if int(row1[16]) <= 10 and int(row1[16]) >=6:
		adi6to10.append(int(row1[9])/scale)
	if int(row1[16]) <= 14 and int(row1[16]) >=11:
		adi11to14.append(int(row1[9])/scale)
	if int(row1[16]) <= 18 and int(row1[16]) >=15:
		adi15to18.append(int(row1[9])/scale)
'''
print("6 to 10")
print(str(adi6to10))
...
ax.set_title('CDF for CSR based on ADI 2019')
